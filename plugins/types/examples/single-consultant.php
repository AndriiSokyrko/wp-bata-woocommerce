 ...
 * It is based on the original Twenty Sixteen theme's sibgle-stuff.php file.
...
<!-- TYPES TIP: Custom call to Types function to render a custom field "Consultant Contact Phone" -->
			...
			<?php
			// TYPES TIP: all of the lines below this point are the standard part of a sibgle-stuff.php of the Twenty Sixteen theme.
