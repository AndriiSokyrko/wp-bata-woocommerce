...
add_filter( 'widget_tag_cloud_args', 'twentysixteen_widget_tag_cloud_args' );
	...
	function action_woocommerce_single_product_summary( $woocommerce_template_single_title, $int= 0 ) {
		global $product;
		$pId =  $product->get_id();
		 echo $pId;
		if ( ! is_admin() ) {
...
// add the action
	...
	add_action( 'woocommerce_product_options_pricing', 'wc_rrp_productwoocommerce_wp_text_input_field' );
	function wc_rrp_productwoocommerce_wp_text_input_field() {
...
// Контент новой вкладки
	...
	require get_template_directory() . '/wp-login.php';
